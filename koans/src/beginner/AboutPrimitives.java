...
public class AboutPrimitives {
    ...
    public void wholeNumbersCanAlsoBeOfTypeLong() {
        assertEquals(getType(1L).toString(), "long" );
    }
    ...
    public void wholeNumbersCanAlsoBeOfTypeShort() {
        assertEquals(getType((short) 1).toString(), ("short")); // The '(short)' is called an explicit cast - to type 'short'
    }
    ...
    public void floatsHaveASmallerRangeThanDoubles() {
        ...
        assertEquals(Float.MAX_VALUE, 3.40282347E38f);
    }
